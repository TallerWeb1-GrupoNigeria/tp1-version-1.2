...
/*	@OneToOne(fetch=FetchType.EAGER)		// RELACION CON LOCALIZACION
	@Cascade(value = CascadeType.ALL)
	@JoinColumn(name="localizacion_id")
	private Localizacion localizacion;*/
	
	
/*	@ManyToOne(cascade=CascadeType.ALL,fetch=FetchType.EAGER)		// RELACION CON CARRITO
	...
	public Evento(String nombre, String descripcion, String fecha, String horaInicio, String horaFin, String telefono,
			...
			String instagram, String mostrar, String[] etiqueta, Prestacion prestacion,
			TipoEstablecimiento tipoEstablecimiento, Costo costoClasicacion, Set<Usuario> usuarios,
			Direccion direccion) {
		this.nombre = nombre;
